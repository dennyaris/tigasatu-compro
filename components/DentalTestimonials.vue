  ...
  <div class="relative isolate bg-white pb-32 pt-24">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      ...
      <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-3">
        <div v-for="(t, idx) in testimonials" :key="idx" class="bg-white">
          <div class="relative aspect-square rounded-md overflow-hidden">
            ...
            <div class="absolute top-0 left-0 w-full h-full">
              <button class="absolute w-18 h-18 flex flex-center bg-primary rounded-full cursor-pointer top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" @click.prevent="handleShowVideo(t)">
              ...
              >
                ...
                <div class="mt-2">
                  <div class="youtube-container">
                    <iframe
                      ref="iframe"
                      :src="`https://www.youtube.com/embed/${modalData.video}?autoplay=1&mute=0&loop=1&color=white&controls=0&modestbranding=1&playsinline=1&rel=0&enablejsapi=1`"
