...
const featuredTestimonial = {
  body: 'Dont give up and never back down, continue to be consistent in distributing diabetes technology and do what you can for diabetes patients for this country and nation.',
  author: {
